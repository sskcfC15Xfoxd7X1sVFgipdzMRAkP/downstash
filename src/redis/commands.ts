...
export function executeCommand(
  ...
  try {
    switch (cmd) {
      case "PING": {
        const result = store.ping(a[0]);
        return { result: encode(result, encoding) };
      }
      case "ECHO": {
        const err = exactArgs(a, 1, "echo");
        if (err) return { error: err };
        return { result: encode(store.echo(a[0]!), encoding) };
      }
      case "TIME": {
        return { result: store.time().map((v) => encode(v, encoding)) };
      }
      case "SET": {
        ...
        return { result: opts.get ? encode(result, encoding) : result };
      }
      case "GET": {
        const err = exactArgs(a, 1, "get");
        if (err) return { error: err };
        return { result: encode(store.get(a[0]!), encoding) };
      }
      case "MSET": {
      ...
      case "MGET": {
        ...
        if (err) return { error: err };
        return { result: store.mget(a).map((v) => encode(v, encoding)) };
      }
      case "SETNX": {
      ...
      case "PSETEX": {
        ...
        const ms = toInt(a[1]!);
        if (ms === null || ms <= 0)
          return { error: "ERR invalid expire time in 'psetex' command" };
      ...
      case "INCRBYFLOAT": {
        ...
        return { result: encode(store.incrbyfloat(a[0]!, inc), encoding) };
      }
      case "DECR": {
      ...
      case "GETRANGE": {
        ...
        return { result: encode(store.getrange(a[0]!, start, end), encoding) };
      }
      case "SETRANGE": {
      ...
      case "GETDEL": {
        ...
        if (err) return { error: err };
        return { result: encode(store.getdel(a[0]!), encoding) };
      }
      case "GETEX": {
        ...
        if (typeof opts === "string") return { error: opts };
        return { result: encode(store.getex(a[0]!, opts), encoding) };
      }
      case "DEL": {
      ...
      case "KEYS": {
        ...
        if (err) return { error: err };
        return { result: store.keys(a[0]!).map((v) => encode(v, encoding)) };
      }
      case "SCAN": {
        ...
        return { result: [String(next), keys.map((v) => encode(v, encoding))] };
      }
      case "DBSIZE": {
      ...
      case "RANDOMKEY": {
        const key = store.randomkey();
        return { result: key !== null ? encode(key, encoding) : null };
      }
      case "COPY": {
      ...
      case "HGET": {
        ...
        if (err) return { error: err };
        return { result: encode(store.hget(a[0]!, a[1]!), encoding) };
      }
      case "HMSET": {
      ...
      case "HMGET": {
        ...
        if (err) return { error: err };
        return { result: store.hmget(a[0]!, a.slice(1)).map((v) => encode(v, encoding)) };
      }
      case "HGETALL": {
        const err = exactArgs(a, 1, "hgetall");
        if (err) return { error: err };
        return { result: store.hgetall(a[0]!).map((v) => encode(v, encoding)) };
      }
      case "HDEL": {
      ...
      case "HKEYS": {
        ...
        if (err) return { error: err };
        return { result: store.hkeys(a[0]!).map((v) => encode(v, encoding)) };
      }
      case "HVALS": {
        const err = exactArgs(a, 1, "hvals");
        if (err) return { error: err };
        return { result: store.hvals(a[0]!).map((v) => encode(v, encoding)) };
      }
      case "HINCRBY": {
      ...
      case "HINCRBYFLOAT": {
        ...
        if (inc === null) return { error: "ERR value is not a valid float" };
        return { result: encode(store.hincrbyfloat(a[0]!, a[1]!, inc), encoding) };
      }
      case "HSETNX": {
      ...
      case "HSCAN": {
        ...
        return { result: [String(next), items.map((v) => encode(v, encoding))] };
      }
      ...
      case "LPOP": {
        ...
        if (a.length > 1) {
          ...
          if (count === null || count < 0)
            return { error: "ERR value is not an integer or out of range" };
          const result = store.lpop(a[0]!, count);
          return { result: result !== null ? (result as string[]).map((v) => encode(v, encoding)) : null };
        }
        return { result: encode(store.lpop(a[0]!), encoding) };
      }
      case "RPOP": {
        ...
        if (a.length > 1) {
          ...
          if (count === null || count < 0)
            return { error: "ERR value is not an integer or out of range" };
          const result = store.rpop(a[0]!, count);
          return { result: result !== null ? (result as string[]).map((v) => encode(v, encoding)) : null };
        }
        return { result: encode(store.rpop(a[0]!), encoding) };
      }
      case "LRANGE": {
        ...
        if (start === null || stop === null)
          return { error: "ERR value is not an integer or out of range" };
        return { result: store.lrange(a[0]!, start, stop).map((v) => encode(v, encoding)) };
      }
      case "LLEN": {
      ...
      case "LINDEX": {
        ...
        return { result: encode(store.lindex(a[0]!, index), encoding) };
      }
      case "LSET": {
      ...
      case "SMEMBERS": {
        ...
        if (err) return { error: err };
        return { result: store.smembers(a[0]!).map((v) => encode(v, encoding)) };
      }
      case "SISMEMBER": {
      ...
      case "SPOP": {
        ...
        if (a.length > 1) {
          const count = toInt(a[1]!);
          if (count === null) return { error: "ERR value is not an integer or out of range" };
          const result = store.spop(a[0]!, count);
          return { result: result !== null ? (result as string[]).map((v) => encode(v, encoding)) : null };
        }
        return { result: encode(store.spop(a[0]!), encoding) };
      }
      case "SRANDMEMBER": {
        ...
        if (a.length > 1) {
          const count = toInt(a[1]!);
          if (count === null) return { error: "ERR value is not an integer or out of range" };
          const result = store.srandmember(a[0]!, count);
          return { result: result !== null ? (result as string[]).map((v) => encode(v, encoding)) : null };
        }
        return { result: encode(store.srandmember(a[0]!), encoding) };
      }
      case "SUNION": {
        const err = minArgs(a, 1, "sunion");
        if (err) return { error: err };
        return { result: store.sunion(a).map((v) => encode(v, encoding)) };
      }
      case "SINTER": {
        const err = minArgs(a, 1, "sinter");
        if (err) return { error: err };
        return { result: store.sinter(a).map((v) => encode(v, encoding)) };
      }
      case "SDIFF": {
        const err = minArgs(a, 1, "sdiff");
        if (err) return { error: err };
        return { result: store.sdiff(a).map((v) => encode(v, encoding)) };
      }
      case "SUNIONSTORE": {
      ...
      case "ZRANGE": {
        ...
        const result = store.zrange(a[0]!, start, stop, withScores);
        return { result: result.map((v) => encode(v, encoding)) };
      }
      case "ZRANGEBYSCORE": {
        const err = minArgs(a, 3, "zrangebyscore");
        if (err) return { error: err };
        const opts = parseZRangeByScoreOptions(a.slice(3));
        const result = store.zrangebyscore(a[0]!, a[1]!, a[2]!, opts);
        return { result: result.map((v) => encode(v, encoding)) };
      }
      case "ZREVRANGE": {
        ...
        if (start === null || stop === null)
          return { error: "ERR value is not an integer or out of range" };
        const withScores = a.length > 3 && a[3]!.toUpperCase() === "WITHSCORES";
        const result = store.zrevrange(a[0]!, start, stop, withScores);
        return { result: result.map((v) => encode(v, encoding)) };
      }
      case "ZREVRANGEBYSCORE": {
        ...
        if (err) return { error: err };
        const opts = parseZRangeByScoreOptions(a.slice(3));
        const result = store.zrevrangebyscore(a[0]!, a[1]!, a[2]!, opts);
        return { result: result.map((v) => encode(v, encoding)) };
      }
      case "ZCARD": {
      ...
      case "ZINCRBY": {
        ...
        const inc = toFloat(a[1]!);
        if (inc === null) return { error: "ERR value is not a valid float" };
        return { result: encode(store.zincrby(a[0]!, inc, a[2]!), encoding) };
      }
      case "ZPOPMIN": {
        ...
        if (count === null) return { error: "ERR value is not an integer or out of range" };
        const result = store.zpopmin(a[0]!, count);
        return { result: result.map((v) => encode(v, encoding)) };
      }
      case "ZPOPMAX": {
        ...
        const count = a.length > 1 ? toInt(a[1]!) : 1;
        if (count === null) return { error: "ERR value is not an integer or out of range" };
        const result = store.zpopmax(a[0]!, count);
        return { result: result.map((v) => encode(v, encoding)) };
      }
      case "ZUNIONSTORE": {
